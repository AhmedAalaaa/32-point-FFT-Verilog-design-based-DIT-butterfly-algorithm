...
a(8 + dummy) = x(2 + dummy) + ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * x(14 + dummy));
a(9 + dummy) = x(2 + dummy) - ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * x(14 + dummy));
...
b(1 + dummy) = a(1 + dummy) + ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(3 + dummy));
b(3 + dummy) = a(1 + dummy) - ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(3 + dummy));
...
b(5 + dummy) = a(5 + dummy) + ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(7 + dummy));
b(7 + dummy) = a(5 + dummy) - ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(7 + dummy));
...
b(9 + dummy) = a(9 + dummy) 	+ ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(11 + dummy));
b(11 + dummy) = a(9 + dummy) 	- ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(11 + dummy));
...
b(13 + dummy) = a(13 + dummy) + ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(15 + dummy));
b(15 + dummy) = a(13 + dummy) - ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(15 + dummy));
...
b(17 + dummy) = a(17 + dummy) + ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(19 + dummy));
b(19 + dummy) = a(17 + dummy) - ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(19 + dummy));
...
b(21 + dummy) = a(21 + dummy) + ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(23 + dummy));
b(23 + dummy) = a(21 + dummy) - ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(23 + dummy));
...
b(25 + dummy) = a(25 + dummy) + ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(27 + dummy));
b(27 + dummy) = a(25 + dummy) - ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(27 + dummy));
...
b(29 + dummy) = a(29 + dummy) + ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(31 + dummy));
b(31 + dummy) = a(29 + dummy) - ((twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * a(31 + dummy));
...
c(1 + dummy) = b(1 + dummy) + ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(5 + dummy));
c(5 + dummy) = b(1 + dummy) - ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(5 + dummy));
c(2 + dummy) = b(2 + dummy) + ((	twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(6 + dummy));
c(6 + dummy) = b(2 + dummy) - ((	twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(6 + dummy));
c(3 + dummy) = b(3 + dummy) + ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(7 + dummy));
c(7 + dummy) = b(3 + dummy) - ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(7 + dummy));
...
c(9 + dummy) = b(9 + dummy) 	+ ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(13 + dummy));
c(13 + dummy) = b(9 + dummy) 	- ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(13 + dummy));
c(10 + dummy) = b(10 + dummy) 	+ ((	twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(14 + dummy));
c(14 + dummy) = b(10 + dummy) 	- ((	twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(14 + dummy));
c(11 + dummy) = b(11 + dummy) 	+ ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(15 + dummy));
c(15 + dummy) = b(11 + dummy) 	- ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(15 + dummy));
...
c(17 + dummy) = b(17 + dummy) + ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(21 + dummy));
c(21 + dummy) = b(17 + dummy) - ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(21 + dummy));
c(18 + dummy) = b(18 + dummy) + ((	twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(22 + dummy));
c(22 + dummy) = b(18 + dummy) - ((	twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(22 + dummy));
c(19 + dummy) = b(19 + dummy) + ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(23 + dummy));
c(23 + dummy) = b(19 + dummy) - ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(23 + dummy));
...
c(25 + dummy) = b(25 + dummy) + ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(29 + dummy));
c(29 + dummy) = b(25 + dummy) - ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(29 + dummy));
c(26 + dummy) = b(26 + dummy) + ((	twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(30 + dummy));
c(30 + dummy) = b(26 + dummy) - ((	twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(30 + dummy));
c(27 + dummy) = b(27 + dummy) + ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(31 + dummy));
c(31 + dummy) = b(27 + dummy) - ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * b(31 + dummy));
...
d(1 + dummy) = c(1 + dummy) + ((	twiddle_rom_real(4 + dummy) - 1j * twiddle_rom_imag(4 + dummy)) * c(9 + dummy));
d(9 + dummy) = c(1 + dummy) - ((	twiddle_rom_real(4 + dummy) - 1j * twiddle_rom_imag(4 + dummy)) * c(9 + dummy));
d(2 + dummy) = c(2 + dummy) + ((	twiddle_rom_real(8 + dummy) - 1j * twiddle_rom_imag(8 + dummy)) * c(10 + dummy));
d(10 + dummy) = c(2 + dummy) - ((	twiddle_rom_real(8 + dummy) - 1j * twiddle_rom_imag(8 + dummy)) * c(10 + dummy));
d(3 + dummy) = c(3 + dummy) + ((	twiddle_rom_real(12 + dummy) - 1j * twiddle_rom_imag(12 + dummy)) * c(11 + dummy));
d(11 + dummy) = c(3 + dummy) - ((	twiddle_rom_real(12 + dummy) - 1j * twiddle_rom_imag(12 + dummy)) * c(11 + dummy));
d(4 + dummy) = c(4 + dummy) + ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * c(12 + dummy));
d(12 + dummy) = c(4 + dummy) - ((-1 * twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * c(12 + dummy));
d(5 + dummy) = c(5 + dummy) + ((	twiddle_rom_real(12 + dummy) + 1j * twiddle_rom_imag(12 + dummy)) * c(13 + dummy));	% here
d(13 + dummy) = c(5 + dummy) - ((	twiddle_rom_real(12 + dummy) + 1j * twiddle_rom_imag(12 + dummy)) * c(13 + dummy));	% here
d(6 + dummy) = c(6 + dummy) + ((	twiddle_rom_real(8 + dummy) + 1j * twiddle_rom_imag(8 + dummy)) * c(14 + dummy));  	% here
d(14 + dummy) = c(6 + dummy) - ((	twiddle_rom_real(8 + dummy) + 1j * twiddle_rom_imag(8 + dummy)) * c(14 + dummy));	% here
d(7 + dummy) = c(7 + dummy) + ((	twiddle_rom_real(4 + dummy) + 1j * twiddle_rom_imag(4 + dummy)) * c(15 + dummy));	% here
d(15 + dummy) = c(7 + dummy) - ((	twiddle_rom_real(4 + dummy) + 1j * twiddle_rom_imag(4 + dummy)) * c(15 + dummy));	% here
...
d(17 + dummy) = c(17 + dummy) + ((	twiddle_rom_real(4 + dummy) - 1j * twiddle_rom_imag(4 + dummy)) * c(25 + dummy));
d(25 + dummy) = c(17 + dummy) - ((	twiddle_rom_real(4 + dummy) - 1j * twiddle_rom_imag(4 + dummy)) * c(25 + dummy));
d(18 + dummy) = c(18 + dummy) + ((	twiddle_rom_real(8 + dummy) - 1j * twiddle_rom_imag(8 + dummy)) * c(26 + dummy));
d(26 + dummy) = c(18 + dummy) - ((	twiddle_rom_real(8 + dummy) - 1j * twiddle_rom_imag(8 + dummy)) * c(26 + dummy));
d(19 + dummy) = c(19 + dummy) + ((	twiddle_rom_real(12 + dummy) - 1j * twiddle_rom_imag(12 + dummy)) * c(27 + dummy));
d(27 + dummy) = c(19 + dummy) - ((	twiddle_rom_real(12 + dummy) - 1j * twiddle_rom_imag(12 + dummy)) * c(27 + dummy));
d(20 + dummy) = c(20 + dummy) + ((-1 *	twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * c(28 + dummy));
d(28 + dummy) = c(20 + dummy) - ((-1 *	twiddle_rom_real(0 + dummy) - 1j * twiddle_rom_imag(0 + dummy)) * c(28 + dummy));
d(21 + dummy) = c(21 + dummy) + ((	twiddle_rom_real(12 + dummy) + 1j * twiddle_rom_imag(12 + dummy)) * c(29 + dummy));		% here
d(29 + dummy) = c(21 + dummy) - ((	twiddle_rom_real(12 + dummy) + 1j * twiddle_rom_imag(12 + dummy)) * c(29 + dummy));		% here
d(22 + dummy) = c(22 + dummy) + ((	twiddle_rom_real(8 + dummy) + 1j * twiddle_rom_imag(8 + dummy)) * c(30 + dummy));		% here
d(30 + dummy) = c(22 + dummy) - ((	twiddle_rom_real(8 + dummy) + 1j * twiddle_rom_imag(8 + dummy)) * c(30 + dummy));		% here
d(23 + dummy) = c(23 + dummy) + ((	twiddle_rom_real(4 + dummy) + 1j * twiddle_rom_imag(4 + dummy)) * c(31 + dummy));		% here
d(31 + dummy) = c(23 + dummy) - ((	twiddle_rom_real(4 + dummy) + 1j * twiddle_rom_imag(4 + dummy)) * c(31 + dummy));		% here
